        ...
        <div id="sidebar-menu-3" class="sidebar-menu">
            <div class="main-menu">
                <ul class="nav-menu">
                    ...
                    <li class="submenu">
                        <a href="javascript:void(0);"><i class="ti ti-layout-grid fs-16 me-2"></i><span>Sales &amp; Purchase</span>
                    ...
                    <li class="submenu">
                        ...
                        <ul>
                            ...
                            <li class="submenu">
                                ...
                                <ul>
                                    <li>
                                        <a href="https://dreamspos.dreamstechnologies.com/documentation/html.html"><span>Documentation</span></a>
                                    </li>
                                    <li><a href="https://dreamspos.dreamstechnologies.com/documentation/changelog.html"><span>Changelog v2.2.2</span></a>
                                    </li>
                                    <li class="submenu">
                    ...
                    <div class="tab-content" id="v-pills-tabContent">
                        ...
                        <div class="tab-pane fade" id="extras">
                            <ul>
                                ...
                                <li><a href="https://dreamspos.dreamstechnologies.com/documentation/html.html"><span>Documentation</span></a>
                                </li>
                                <li>
                                    <a href="https://dreamspos.dreamstechnologies.com/documentation/changelog.html"><span>Changelog v2.2.2</span></a>
                                </li>
                                <li class="submenu">
                                    <a href="javascript:void(0);"><span>Multi Level</span><span
                                            class="menu-arrow"></span></a>
...
<!-- ApexChart JS -->
{{--<script src="assets/plugins/apexchart/apexcharts.min.js" type="749ffe33f85148c350856405-text/javascript"></script>--}}
{{--<script src="assets/plugins/apexchart/chart-data.js" type="749ffe33f85148c350856405-text/javascript"></script>--}}

<!-- Chart JS -->
{{--<script src="assets/plugins/chartjs/chart.min.js" type="749ffe33f85148c350856405-text/javascript"></script>--}}
{{--<script src="assets/plugins/chartjs/chart-data.js" type="749ffe33f85148c350856405-text/javascript"></script>--}}

<!-- Daterangepikcer JS -->
{{--<script src="assets/js/moment.min.js" type="749ffe33f85148c350856405-text/javascript"></script>--}}
