                    ...
                    <ul class="nav-menu">
                        ...
                        <li class="submenu">
                            <a href="javascript:void(0);"><i
                                    class="ti ti-page-break fs-16 me-2"></i><span>Pages</span>
                                <span class="menu-arrow"></span></a>
                            <ul>
                            ...
                            <ul>
                                ...
                                <li class="submenu">
                                    ...
                                    <ul>
                                        <li>
                                            <a
                                                href="https://dreamspos.dreamstechnologies.com/documentation/html.html"><span>Documentation</span></a>
                                        </li>
                                        <li><a
                                                href="https://dreamspos.dreamstechnologies.com/documentation/changelog.html"><span>Changelog
                                                    v2.2.2</span></a>
                                        </li>
                                        <li class="submenu">
                ...
                case 422:
                    ...
                    $.each(errors, function(field, messages) {
                        ...
                        if (input.length) {
                            ...
                            if (input.is(':checkbox') || input.is(':radio') || (input.is('select') && input.attr(
                                    'multiple'))) {
                                ...
                                let container = input.closest(
                                    '.form-group, .mb-3, .col-md-6, .checkbox-group, .select2-container');
                                if (!container.find('.invalid-feedback').length) {
                                    container.append('<div class="invalid-feedback d-block">' + messages[0] +
                                        '</div>');
                                }
                            }
                            // For single select
                            ...
                            let container = $('[id*="' + field + '"], [class*="' + field + '"]').closest(
